...
void myInitOGLFun()
{
    ...
    sgct::TextureManager::instance()->loadTexure("box", "water.png", true);
    
    //myBox = new sgct_utils::SGCTBox(2.0f, sgct_utils::SGCTBox::Regular);
    //myBox = new sgct_utils::SGCTBox(2.0f, sgct_utils::SGCTBox::CubeMap);
    myBox = new sgct_utils::SGCTBox(landscapeSize, sgct_utils::SGCTBox::Regular);
...
void myDrawFun()
{
    ...
    glm::mat4  scene_mat = glm::translate( glm::mat4(1.0f), sgct::Engine::getDefaultUserPtr()->getPos() );
    scene_mat *= ViewRotateX;
    scene_mat *= glm::translate(glm::mat4(1.0f), pos);
    scene_mat *= glm::translate( glm::mat4(1.0f), -sgct::Engine::getDefaultUserPtr()->getPos() );
    //scene_mat = glm::translate( glm::mat4(1.0f), glm::vec3( 0.0f, 1.0f, 0.0f) );
